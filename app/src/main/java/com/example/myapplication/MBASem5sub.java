...
public class MBASem5sub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mbasem5sub);

        listView = findViewById(R.id.msem5subList);
        ...
        sub1yearlist.setItems(yearlist, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(MBASem5sub.this,PDFWebView.class);
