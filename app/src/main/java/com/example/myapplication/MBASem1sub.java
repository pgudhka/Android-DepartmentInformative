...
public class MBASem1sub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mbasem1sub);

        listView = findViewById(R.id.msem1subList);
        ...
        sub1yearlist.setItems(yearlist, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(MBASem1sub.this,PDFWebView.class);
