...
public class MBASem4sub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mbasem4sub);

        listView = findViewById(R.id.msem4subList);
        ...
        sub1yearlist.setItems(yearlist, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(MBASem4sub.this,PDFWebView.class);
