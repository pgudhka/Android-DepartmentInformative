...
public class BMttTt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bmtt_tt);

        Intent intent = getIntent();
        Bundle bundle = intent.getExtras();
        sem_select = bundle.getInt("sem");

        mttselect = findViewById(R.id.bmttselect);
        mttview = findViewById(R.id.bmttview);
