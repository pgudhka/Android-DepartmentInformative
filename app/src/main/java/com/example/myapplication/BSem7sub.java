...
public class BSem7sub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bsem7sub);
        listView = findViewById(R.id.bsem7subList);
        ...
        sub1yearlist.setItems(yearlist, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(BSem7sub.this,PDFWebView.class);
