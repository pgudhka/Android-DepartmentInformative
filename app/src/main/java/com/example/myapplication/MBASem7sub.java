...
public class MBASem7sub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mbasem7sub);

        listView = findViewById(R.id.msem7subList);
        ...
        sub1yearlist.setItems(yearlist, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent intent = new Intent(MBASem7sub.this,PDFWebView.class);
